...
const cols = ['#c83d79','#409d3b']; for (let i=0;i<=1;i++) { $(`#pts${i}`).css({color:cols[i]}) }
const boardSize = 600
const plrSize = 85
const speed = 10
const baseTrailSize = 30
const round = Math.round // To cache the function
var trailSize = 0
var FPSCount = document.getElementById('FPS') //To find FPS
var mslf = 0
